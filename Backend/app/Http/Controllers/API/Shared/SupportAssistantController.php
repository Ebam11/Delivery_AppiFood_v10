        ...
        $messages = [
            [
                ...
                'content' => implode("\n", [
                    ...
                    '4. Soporte Técnico: ÚNICAMENTE si el usuario solicita explícitamente comunicarse con soporte técnico, ayuda de un humano, o crear un ticket de soporte, debes proveer la acción: {"label": "Ir al soporte", "path": "/support"}. Bajo ninguna otra circunstancia (como saludos, preguntas de restaurantes o dudas generales de la app) debes incluir la acción de soporte.',
                    '5. NUNCA respondas con listas genéricas de "Puedo ayudarte con pedidos, pagos, etc.". Lee la pregunta del usuario y responde específicamente a lo que pide.',
