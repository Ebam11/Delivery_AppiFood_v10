...
export default function CartSidebar({ isAuth }) {
  ...
  return (
    <>
      ...
      {/* Panel */}
      <aside className={`fixed top-0 right-0 h-full w-full max-w-[400px] bg-white z-[71] flex flex-col shadow-2xl transition-transform duration-300 ${isOpen ? 'translate-x-0' : 'translate-x-full'}`}>
