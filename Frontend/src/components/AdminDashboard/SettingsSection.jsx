    ...
    <div className="max-w-4xl space-y-8 animate-fade-in pb-10">
      ...
      <section className="bg-red-50 dark:bg-red-950/20 rounded-2xl border border-red-100 dark:border-red-900/30 shadow-sm overflow-hidden">
        ...
        <div className="p-6 flex flex-wrap gap-4">
          <button 
            onClick={() => { if(confirm(t('adminDashboard.settings.backup_confirm') || '¿Generar backup de la base de datos?')) showToast(t('adminDashboard.toast.backupDone') || 'Backup iniciado...') }} 
          ...
          <button 
            onClick={() => { if(confirm(t('adminDashboard.settings.maintenanceConfirm') || '¿Activar modo mantenimiento?')) showToast(t('adminDashboard.toast.maintenanceOn') || 'Modo mantenimiento activado') }} 
